...
namespace Actmis.Models
{
    ...
    public partial class ActmisDBEntities : DbContext
    {
        public ActmisDBEntities()
            : base("name=ActmisDBEntities")
        {
        }
        ...
        public virtual DbSet<tEvents_Type> tEvents_Type { get; set; }
